...
import { productSchema, ProductType } from "@/app/product/modify/[id]/schema";
import { getUploadUrl, uploadProduct } from "@/app/product/modify/[id]/actions";
...
export default function ModifyProduct({ product }: ModifyProps) {
